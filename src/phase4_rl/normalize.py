...
if __name__ == "__main__":
    ...
    mock_vec_env = DummyVecEnv([make_env])
    
    # Test VecNormalize manager
    manager = VecNormalizeManager("test_vecnorm_stats")
    
    print("VecNormalize Manager Test")
    print("=" * 40)
    ...
    available = manager.list_available_stats()
    print(f"Available stats: {len(available)}")
    
    for stats in available:
        print(f"  - {stats['stats_id']} (v{stats['obs_version']})")
