"""
Flat PPO training script with comprehensive logging and stability features.

This module contains the extracted flat (non-hierarchical) PPO training logic
for maintaining backward compatibility while supporting HRL development.
"""
...
def main():
    """Main entry point for flat PPO training."""
    parser = argparse.ArgumentParser(description="Train flat PPO agent for missile interception")
    parser.add_argument(
        "--config",
        type=str,
        default="config.yaml",
